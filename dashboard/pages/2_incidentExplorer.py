...
if not st.session_state.get("authenticated", False):
    auth_protected_gate("Incident Explorer & Violation Logs")
    st.stop()
...
""", unsafe_allow_html=True)
    ...
    navigation_tip()
    if st.button("Sign Out", key="incident_signout_sidebar", use_container_width=True):
...
render_authenticated_nav(current_page="Incident Explorer", user_info=st.session_state.get("user"))
